...
def exibir_nome_do_programa():
    """
    Função para exibir o nome do programa (banner).
    """
    print("""
██████╗░███████╗██████╗░██╗██╗░░░██╗██╗  ░█████╗░██╗░░██╗███████╗░██████╗░░█████╗░██╗░░░██╗██╗
██╔══██╗██╔════╝██╔══██╗██║██║░░░██║██║  ██╔══██╗██║░░██║██╔════╝██╔════╝░██╔══██╗██║░░░██║██║
...
def voltar_ao_menu_principal():
    """
    Função para voltar ao menu principal (espera entrada do usuário).
    """
...
def exibir_subtitulo(texto):
    """
    Função para exibir um subtítulo, limpando o console antes de imprimir.
    """
    os.system('clear')
    linha = '*' * (len(texto))
    print(linha)
